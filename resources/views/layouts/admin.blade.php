...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('backend1/img/icons/icon-48x48.png')}}"/>
    <link rel="canonical" href="https://demo-basic.adminkit.io/"/>
    <title>AdminKit - @yield('title')</title>
    <link href="{{asset('backend1/css/app.css')}}" rel="stylesheet">
    ...
    <nav id="sidebar" class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
            <a class="sidebar-brand" href="{{route('dashboard')}}">
                <span class="align-middle">Manager Shop Aneed</span>
            </a>
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item - {{Request::is('category') ? 'active' :''}}">
                    <a class="sidebar-link" href="{{asset('category')}}">
                ...
                <li class="sidebar-item -  {{Request::is('product') ? 'active' :''}}">
                    <a class="sidebar-link" href="{{asset('product')}}">
                ...
                <ul class="navbar-nav navbar-align">
                        ...
                        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0"
                            ...
                            <div class="list-group">
                                ...
                                <a href="#" class="list-group-item">
                                    <div class="row g-0 align-items-center">
                                        <div class="col-2">
                                            <img src="{{asset('backend1/img/avatars/avatar-4.jpg')}}"
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                            <img src="{{asset('backend1/img/avatars/avatar.jpg')}}"
...
<script src="{{asset('backend1/js/app.js')}}"></script>
<script src="{{asset('backend1/js/ajax-form.js')}}"></script>
<script src="{{asset('backend1/js/category.js')}}"></script>
<script src="{{asset('backend1/js/product.js')}}"></script>
