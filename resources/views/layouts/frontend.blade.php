        ...
        <div class="order-lg-last btn-group">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                <div class="dropdown-item d-flex align-items-start" href="#">
                    <div class="img" style="background-image: url({{asset('fontend/images/prod-1.jpg')}}"></div>
                    <div class="text pl-3">
                        <h4>Bacardi 151</h4>
                ...
                <div class="dropdown-item d-flex align-items-start" href="#">
                    <div class="img" style="background-image: url({{asset('fontend/images/prod-2.jpg')}}"></div>
                    <div class="text pl-3">
                ...
                <div class="dropdown-item d-flex align-items-start" href="#">
                    <div class="img" style="background-image: url({{asset('fontend/images/prod-3.jpg)}}"></div>
                    <div class="text pl-3">
                        <h4>Citadelle</h4>
...
<div class="hero-wrap" style="background-image: url({{asset('fontend/images/bg_2.jpg')}})" data-stellar-background-ratio="0.5">
...
<section class="ftco-section ftco-no-pb">
    <div class="container">
        <div class="row">
            <div class="col-md-6 img img-3 d-flex justify-content-center align-items-center" style="background-image: url({{asset('fontend/images/about.jpg')}}">
            </div>
        ...
        <div class="row">
            <div class="col-lg-2 col-md-4 ">
                <div class="sort w-100 text-center ftco-animate">
                    <div class="img" style="background-image: url({{asset('fontend/images/kind-1.jpg')}}"></div>
                    <h3>Brandy</h3>
                </div>
            </div>
            <div class="col-lg-2 col-md-4 ">
                <div class="sort w-100 text-center ftco-animate">
                    <div class="img" style="background-image: url({{asset('fontend/images/kind-2.jpg')}}"></div>
                    <h3>Gin</h3>
                </div>
            </div>
            <div class="col-lg-2 col-md-4 ">
                <div class="sort w-100 text-center ftco-animate">
                    <div class="img" style="background-image: url({{asset('fontend/images/kind-3.jpg')}}"></div>
                    <h3>Rum</h3>
                </div>
            </div>
            <div class="col-lg-2 col-md-4 ">
                <div class="sort w-100 text-center ftco-animate">
                    <div class="img" style="background-image: url({{asset('fontend/images/kind-4.jpg')}}"></div>
                    <h3>Tequila</h3>
                </div>
            </div>
            <div class="col-lg-2 col-md-4 ">
                <div class="sort w-100 text-center ftco-animate">
                    <div class="img" style="background-image: url({{asset('fontend/images/kind-5.jpg')}}"></div>
                    <h3>Vodka</h3>
                </div>
            </div>
            <div class="col-lg-2 col-md-4 ">
                <div class="sort w-100 text-center ftco-animate">
                    <div class="img" style="background-image: url({{asset('fontend/images/kind-6.jpg')}}"></div>
                    <h3>Whiskey</h3>
                </div>
            </div>
